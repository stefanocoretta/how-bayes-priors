...
```{r rt-1-pp-plot, echo=FALSE, fig.width=7, fig.height=4, out.width="800px", fig.retina=2, fig.align="center", warning=FALSE}
rt_1_pp_d <- rt_1_pp %>%
...
# Accuracy and phonemic density by word type
